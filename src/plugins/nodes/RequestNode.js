...
export default class RequestNodeDefinition extends NodeDefinition {

    static get type() { return 'request'; }

    constructor(x, y, _label, note, data) {
        super(x, y, 'request', note, data);
        this.width = 192;
        this.height = 96;
    ...
    getShapeTemplate() { return `<path d="M73 0 96 23 119 0 176 0A16 16 90 01192 16L192 68A32 32 90 01160 96L32 96A32 32 90 010 64L0 16A16 16 90 0116 0Z" />`;}
}