...
import BidirectionalHandlerDefinition from '../handles/BidirectionalHandler.js';

export default class CallNodeDefinition extends NodeDefinition {

    static get type() { return 'call'; }
    
    constructor(x, y, _label, note, data) {
        super(x, y, 'call', note, data);
        this.width = 192;
        this.height = 96;
    ...
    getShapeTemplate() { return `<path d=" M32 0 176 0A16 16 90 01192 16L192 28A20 20 90 00192 68L192 80A16 16 90 01176 96L119 96 96 73 73 96 16 96A16 16 90 010 80L0 68 12 68 12 28 0 28 0 16A16 16 90 0116 0Z" />`;}
}