...
export default class EndNodeDefinition extends NodeDefinition {
    ...
    getShapeTemplate() { return `<path d="M160 96 16 96A16 16 90 010 80L0 68 12 68 12 28 0 28 0 16A16 16 90 0116 0L160 0A32 32 90 01192 32L192 64A32 32 90 01160 96Z" />`;}
